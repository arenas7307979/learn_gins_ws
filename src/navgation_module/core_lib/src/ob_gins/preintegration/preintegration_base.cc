...
#include "ob_gins/preintegration/preintegration_base.h"
#include "iostream"
...
void PreintegrationBase::integration(const IMU &imu_pre, const IMU &imu_cur) {
    ...
    // std::cout << "imu_cur.dvel =" << imu_cur.dvel  <<std::endl;
    // std::cout << "imu_pre.dvel =" << imu_pre.dvel  <<std::endl;
    // std::cout << "imu_cur.dtheta =" << imu_cur.dtheta  <<std::endl;
    // std::cout << "imu_pre.dtheta =" << imu_pre.dtheta  <<std::endl;
    ...
    // std::cout << "obgins dt=" << dt << std::endl;
    // std::cout << "obgins dtheta=" << dtheta << std::endl;
    // std::cout << "obgins dvfb=" << dvfb << std::endl;
    // std::cout << "obgins dvel=" << dvel << std::endl;
    // std::cout << "vsolver in delta_qORI=" << delta_state_.q.coeffs() << std::endl;
    ...
    // std::cout << "obgins delta_state_p=" << delta_state_.p << std::endl;
    // std::cout << "obgins delta_state_.v=" << delta_state_.v << std::endl;
    // std::cout << "obgins delta_state_.q=" << delta_state_.q.coeffs() << std::endl;
    // std::cout << "obgins current_state_.p=" << current_state_.p << std::endl;
    // std::cout << "obgins current_state_.v=" << current_state_.v << std::endl;
    // std::cout << "obgins current_state_.q=" << current_state_.q.coeffs() << std::endl;
}
