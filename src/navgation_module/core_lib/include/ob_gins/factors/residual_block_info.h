...
public:
    ...
    void Evaluate() {
        ...
        // std::cout << "================" <<std::endl;
        // std::cout << "ResidualBlockInfo block[0]="<< block_sizes[0] <<std::endl;
        // std::cout << "ResidualBlockInfo block_sizes="<< block_sizes.size() <<std::endl;
        // std::cout << "ResidualBlockInfo residuals_="<< residuals_ <<std::endl;   
        // std::cout << "ResidualBlockInfo jacobians_="<< raw_jacobians[0] <<std::endl;  
