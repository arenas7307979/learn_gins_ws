            ...
            SideStrategy const& strategy)
    {
        ...
        while (left != right && defensive_check_index < n)
        {
            ...
            if (coordinate > min_value && other_coordinate > other_min && other_coordinate < other_max)
            {
                ...
                {
                    //std::cout << "first " << first_side << " last " << last_side << '\n';
...
//std::cout << "Candidate at " << geometry::wkt(*it) << " first=" << first_side << " last=" << last_side << '\n';
...
//std::cout << "Extreme point lies at " << index << " having " << geometry::wkt(*max_it) << '\n';
...
//std::cout << "Built vector of " << points.size() << '\n';
