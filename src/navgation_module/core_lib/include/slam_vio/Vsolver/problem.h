#ifndef VSOLVER_PROBLEM_H
#define VSOLVER_PROBLEM_H
...
public:
    ...
    bool SolveWithDogLeg(int iterations = 10);
    ...
    MatXX GetJtPrior_nonInv(){ return Jt_prior_;}
    ...
    void SetJtPrior_nonInv(const MatXX& J){Jt_prior_ = J;}
...
private:
    ...
    void InitDL();
    /// 计算dog-leg update
    void computeDogLegUpdate();
    /// 判断dog-leg update是否被接受，并调整delta
    bool IsGoodStepInDL();


    //lost_function for last_marginalization term
    // std::shared_ptr<
    ...
    // dog-leg parameters
    double DL_delta_;
    double DL_epsilon_1_;
    double DL_epsilon_2_;
    double DL_epsilon_3_;
